...
dat$income <- full_data_names$income
```
...
model1c <- lm(ladder ~ BasicNeeds + PsychNeeds + LuxuryConveniences + dataSet, data = dat)
model1d <- lm(ladder ~ BasicNeeds + PsychNeeds + LuxuryConveniences + livingStandard + dataSet, data = dat)
model1e <-lm(ladder ~ BasicNeeds + PsychNeeds + LuxuryConveniences + livingStandard + logIncome + dataSet, data = dat)
